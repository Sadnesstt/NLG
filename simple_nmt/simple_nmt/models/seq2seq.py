...
class Attention(nn.Module):
    ...
    def forward(self, h_src, h_t_tgt, mask = None):
        ...
        if mask is not None:
            ...
            # masked weights would be se to 0 after softmax operation.
...
class Encoder(nn.Module):
    ...
    def forward(self, emb):
        ...
        if isinstance(emb, tuple):
            ...
            # >>>> PackedSequence(data=tensor([1, 3, 2, 4, 3]), batch_size = tensor([2, 2, 1]))
...
class Seq2Seq(nn.Module):
    ...
    def forward(self, src, tgt):
        ...
        for t in range(tgt.size(1)):
            ...
            # this cuases severe bottle-neck.
    ...
    def search(self, src, is_greedy = True, max_length=255):
        ...
        while is_decoding.sum() > 0 and len(indice) < max_length:
            ...
            if is_greedy:
                ...
                y = torch.multinoulli(y_hat.exp().view(batch_size, -1), 1)
                # |y| = (batch_size, 1)
        ...
        # |y_hat| = (bathc_size, length, output_size)
