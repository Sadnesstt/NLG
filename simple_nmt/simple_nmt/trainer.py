...
class MaximumLikelihoodEstimationEngine(Engine):
    ...
    def attach(
        ...
        if verbose >= VERBOSE_EPOCH_WISE:
            ...
            def print_valid_logs(engine):
                ...
                print('Validation - loss = {:.4e} ppl = {:.2f} best_loss = {:.4e} bset_ppl = {:.2f}'.format(
                    avg_loss,
                    np.exp(avg_loss),
                    engine.best_loss,
    ...
    @staticmethod
    def resume_trainig(engine, resume_epoch):
    ...
    def save_model(engine, train_engine, config, src_vocab, tgt_vocab):
        ...
        # Set a filenmae for model of last epoch.
...
class SingleTrainer():
    ...
    def train(
        ...
        train_engine.add_event_handler(
            Events.STARTED,
            self.target_engine_class.resume_trainig,
